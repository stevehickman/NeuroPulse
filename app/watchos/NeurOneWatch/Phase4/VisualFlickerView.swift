...
// The photoparoxysmal safety cutoff from the NeurOne EEG (Oz electrode,
...
struct VisualFlickerView: View {
    ...
    private var characterisationPending: some View {
        VStack(spacing: 6) {
            ...
            Text(String(localized: "WATCH_40HZ_UNAVAILABLE"))
                .font(.system(size: 12, weight: .semibold))
                .foregroundColor(.white)
            Text(String(localized: "WATCH_BRIGHTNESS_PENDING"))
                .font(.system(size: 10))
                .foregroundColor(.white.opacity(0.5))
                .multilineTextAlignment(.center)
            Text(String(localized: "WATCH_EMDR_ACTIVE"))
                .font(.system(size: 10))
                .foregroundColor(.white.opacity(0.5))
        }
    }
    ...
    private var warningPrompt: some View {
        VStack(spacing: 8) {
            ...
            Text(String(localized: "WATCH_FLASHING_WARNING_TITLE"))
                .font(.system(size: 12, weight: .semibold))
                .foregroundColor(.white)
            Text(String(localized: "WATCH_FLASHING_WARNING_BODY"))
                .font(.system(size: 10))
    ...
    private var activeStatus: some View {
        VStack(spacing: 4) {
            ...
            Text(String(localized: "WATCH_40HZ_ACTIVE"))
                .font(.system(size: 10))
