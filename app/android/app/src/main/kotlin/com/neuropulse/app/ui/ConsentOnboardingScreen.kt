...
import com.neuropulse.core.models.ContactFrequency
...
private fun LayerBlanket(state: ResearchConsentState, onChange: (ResearchConsentState) -> Unit) {
    Text("Pre-approve all NeuroPulse-reviewed research?", fontWeight = FontWeight.Medium)
    Spacer(Modifier.height(8.dp))
    ...
    Text(
        "Once your anonymized data has been included in a published study, it cannot be " +
            "individually withdrawn from that dataset. However, because NeuroPulse anonymises " +
