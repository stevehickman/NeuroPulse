...
/// NeuroPulse cannot cross-reference SHDR records to any user identity.
///
...
enum WarrantyAnalyticsGate {
    ...
    private static let log = Logger(subsystem: "com.neuropulse.analytics", category: "warranty-gate")
