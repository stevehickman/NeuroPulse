...
//
// Predefined protocol definitions, embedded from protocols/predefined/*.npps
// Single source of truth: edit the .npps files, then update this file to match.
// A build script can automate regeneration: scripts/generate-bundled-protocols.swift

enum NPBundledProtocols {

    // MARK: - Single protocol file contents
    ...
    // MARK: - Composite protocol file contents
