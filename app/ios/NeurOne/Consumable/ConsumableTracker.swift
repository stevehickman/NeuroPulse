...
struct ConsumableReminder: Identifiable {
    ...
    // INFRASTRUCTURE — neurone.life
    //
    // Domain   : Primary NeurOne customer-facing domain. Register neurone.life.
    //
    ...
    var orderURL: URL? {
        URL(string: "https://neurone.life/consumables/\(state.kind.shopSlug)")
    }
}
