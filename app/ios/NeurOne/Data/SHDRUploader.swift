...
// SHDR upload to NeurOne fleet database.
...
// INFRASTRUCTURE — fleet.neurone.internal
//
// Domain   : Internal hostname resolved via NeurOne private DNS.
...
private final class SHDRFleetPinningDelegate: NSObject, URLSessionDelegate {
    ...
    // SHA-256 of the DER-encoded SPKI for fleet.neurone.internal.
