...
//  (app/ios/NeuroPulse/WatchBridge/PhoneSessionManager.swift,
//   app/ios/NeuroPulse/WatchBridge/GATTSessionPublishing.swift)
//
...
final class PhoneSessionManagerTests: XCTestCase {
    ...
    func testNoEpochReferenceInForwardPathSource() throws {
        ...
        // toWCMessage() in NeuroPulseShared handles the exclusion; we verify
