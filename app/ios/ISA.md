...
- [x] ISC-107: `OTAManager` fetches the latest firmware manifest from a NeuroPulse distribution endpoint when the hub connects and `OTAView` is opened.
