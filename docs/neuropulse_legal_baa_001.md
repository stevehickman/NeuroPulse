...
Terms used but not otherwise defined in this Agreement shall have the meanings ascribed to them in 45 CFR Parts 160 and 164. The following definitions apply:

**"Agreement"** means this Business Associate Agreement together with any Exhibit attached hereto.
...
**"Secretary"** means the Secretary of the U.S. Department of Health and Human Services or his/her designee.
...
Business Associate shall use appropriate administrative, physical, and technical safeguards, and shall comply with Subpart C of 45 CFR Part 164 with respect to EPHI, to prevent use or disclosure of PHI other than as provided by this Agreement.
...
Business Associate shall limit its access to PHI to the minimum necessary to accomplish the purposes of the Services, consistent with the Minimum Necessary Rule at 45 CFR §164.502(b).
...
**[Select the applicable tier and delete the others]**

| Tier | Monthly fee | Permitted data elements |
|---|---|---|
| **Monitor** | $49/patient/month | Session timestamps (rounded to day), session duration, protocol parameters used (category name only) |
| **Assess** | $149/patient/month | All Monitor + EEG band power ratios (weekly averages), neurofeedback performance scores, session dose (J/cm², weekly aggregate) |
| **Full Clinical** | $299/patient/month | All Assess + HRV RMSSD (weekly aggregate), coherence score trend, closed-loop adaptation event count per session |

**Not permitted under any tier:** Raw EEG waveforms, raw HRV time series, PPG optical signal, session-level timestamps with precision finer than one day, patient name, date of birth, address, contact information.
...
If any patient whose PHI is provided to Business Associate is located in Illinois, Business Associate acknowledges that EEG data may constitute biometric information under the Illinois Biometric Information Privacy Act (BIPA, 740 ILCS 14). Business Associate represents and warrants that it will:

(a) Not sell, lease, trade, or otherwise profit from EEG data;  
(b) Not disclose EEG data to any third party without the relevant patient's written consent, unless required by law;  
(c) Destroy or permanently de-identify EEG data when the initial treatment purpose is satisfied or within three (3) years of the patient's last treatment interaction, whichever comes first.
...
This Agreement shall be effective as of the Effective Date and shall remain in effect until the earlier of: (i) termination of the underlying services agreement between the parties; or (ii) written termination notice by either party with sixty (60) days' advance notice.
...
The parties agree to take such action as is necessary to amend this Agreement to comply with the requirements of HIPAA, HITECH, and any other applicable law or regulation that may be enacted, effective, or amended from time to time.

### 8.2 Survival

The obligations of Business Associate under §§5.1, 5.2, 7.3, and §3.2 shall survive termination or expiration of this Agreement.

### 8.3 No Third-Party Beneficiaries

Nothing in this Agreement shall confer any rights or remedies upon any person or entity other than the parties hereto.
...
This Agreement shall be governed by the laws of the State of [Delaware/other] without regard to its conflict of laws provisions.
