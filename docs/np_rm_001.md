...
>
> **Gap surfaced by the re-baseline:** three shipping T1 modalities — intranasal PBM, neural audio entrainment, and the auricular VNS/HRV clip — have **never had a hazard analysis** in any revision of this risk file. They were invisible while the file was zone-module-shaped. Tracked as `NP-RISK-002` OI-RISK2-02, blocked behind `NP-ART-001` OI-ART-04 (those artifacts have no specification to analyse).
