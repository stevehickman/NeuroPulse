...
- **Cervical VNS (tcVNS) — T2 accessory:**
  ...
  - Connects via existing hub accessory port; separate cable + electrode assembly; gel pad consumable (5-pack), guaranteed for one use, reused until it fails the pre-enable impedance check — consumables row in `docs/reference/commercial-model.md` §2.3 (`OI-ACC-03`, closed 2026-09-22)
