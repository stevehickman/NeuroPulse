...
**(a) `SEAT_N` — HEXTILE is right, and this is the strongest single finding.**
...
it is silent. **`SEAT_N` is adopted.** It is tied to `PGND` on the module through 1 kΩ and placed at
