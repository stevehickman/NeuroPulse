...
| DI-USE-05 | Orientation feature + software placement validation + accessible position ID | DO-HFE-02, ~~DO-HW-04~~, ~~DO-FW-04~~, ~~DO-SW-03~~ | NP-HFE-002 Rev A (L1 landmark grid, L2 app guided placement, L3 module-type marking, L4 `check_placement`); superseded outputs struck — the 5-layer keying they implemented is retired | VE-12 | **Partial** — design output baselined; HFE-R-01..15 evidence pending formative/summative |
