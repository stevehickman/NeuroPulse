# NP-DHF-001 Rev G — NeuroPulse Design History File Index
...
| NP-APP-ROADMAP-001 | iOS App Development Roadmap | B | 2026-06-03 | [neuropulse_ios_app_roadmap_001.md](./neuropulse_ios_app_roadmap_001.md) | ACTIVE — Rev B adds §9 Privacy Constraints (binding engineering constraints): HealthKit residency, minimum age gate (16+), BIPA written release screen for IL users, Adaptive Adjustments card, SDK init gate; open items OI-WA-06, OI-PA-01 through OI-PA-04 | APP |
...
*NP-DHF-001 Rev G — ACTIVE — Effective 2026-06-03*
