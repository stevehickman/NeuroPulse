...
| SW02-M09 | BLE GATT service | (planned) | BLE 5.3 LE Audio; GATT custom service; session sync |
| SW02-M10 | USB-C communications | (planned) | USB-C 3.2 Gen1; session data download; DFU interface |
| SW02-M11 | Fluxgate magnetometer | (planned) | EMF measurement; Helmholtz coil control; SHDR attenuation log |
