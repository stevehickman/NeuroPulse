...
the app's live inventory was the retired 5-slot array until `OI-HFE2-02` closed (2026-09-26): both mobile
pipelines are now socket-indexed. **The build map should reuse that socket-indexed structure rather than
cut a second one. `OI-EEGNET-24`.**
