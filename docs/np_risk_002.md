...
|---|---|---|---|
| **6** | **2026-09-25** | **NeurOne Systems Engineering + principal** | **OI-RISK2-05 gains a dependant; no score in this register changes (GitHub #437).** `NP-FMEA-001` Rev 11 (OI-FMEA-11) re-authored FMEA-M02-05 against the code, and its residual became S5×P1 ALARP. The justification is incomplete until an IWDG is built or rejected here. |
