...
| # | Artifact | Governing spec | Spec maturity | Tooling spec | Risk register | FAI checklist |
|---|---|---|---|---|---|---|
| **A8** | **Hub enclosure** (moulded housing, probe dock, fan door) | `NP-TOOL-HUB-001` Rev 2 | **BASELINED** — F-01's probe-contact geometry **GATED** on `NP-HW-NASAL-001` OI-NASAL-09 (Rev 2) | ✅ `NP-TOOL-HUB-001` | ✅ `NP-RISK-004` | ✅ **`NP-FAI-HUB-001`** Rev 2 — delivered, 5 items gated |
