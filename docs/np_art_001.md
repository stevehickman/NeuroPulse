...
**Related Issues:** **GitHub Issue #394 (Rev 8: OI-ART-02, -03, -06 closed; OI-ART-08 row added)**; GitHub Issue #343 (OI-ART-05); **GitHub Issue #332 (OI-ART-04 — owning specifications for A11–A15; OI-TACS-02 — the driver stage, now A16)**
...
| **A6** | **L0 outer bowl** — CFRP shell + 4-layer EMF stack (Layer 4 absorber deleted 2026-09-23; bowl re-lofted 3 mm inward, `REQ-CAV-04`) | `NP-HEX-ZM-001` §5, `NP-TOOL-SHELL-001` | ⚠ tooling spec written for 5 slots | ⚠ `NP-TOOL-SHELL-001` — see §5 | ✅ `NP-RISK-004` | ⛔ **MECH-1, EMF-1, EMF-3, RISK-20** |
...
| **A19** | **40 Hz mastoid vibrotactile LRA pad** (accessory, `NP-ACC-PRIORITY-001` rank 1, class C1) | `docs/reference/accessories-roadmap.md` (provisional); mounts on `NP-TOOL-SHELL-001` F-04 | ⛔ none | provisional | ⛔ none | ⛔ none | ⛔ F1 |
...
Three active documents were coupled to the retired zone module, and Rev 8 found a fourth. Two of the three are now resolved. Each was left in place rather than
