...
| **OI-ART-09** | **Bring the six Rev 3 specifications to a maturity that satisfies `NP-FAI-001` §2 F1–F2.** `OI-ART-04`'s successor, and deliberately narrower: the artifacts now have owning documents, and what they need is **engineering**, not authoring. Per document: `NP-HW-AUDIO-001` (`OI-AUDIOHW-01…07`, of which the acoustic and bone-conduction exposure ceilings are absent programme-wide); `NP-HW-NASAL-001` (`OI-NASAL-01…08`, with **`OI-NASAL-02` BLOCKING** and **`OI-NASAL-01` gating an already-BASELINED hub mould**); `NP-HW-VNSCLIP-001` (`OI-VNSCLIP-01…07`, including the `OI-CHARGE-07` electrode-area measurement); `NP-HW-CVNS-001` (`OI-CVNSHW-01…08`, including the cross-artifact interlock dependency); `NP-HW-TMS-001` (`OI-TMS-01…06`, itself gated behind **`OI-PWR-02`** and **`OI-PWRTH-01`**, both BLOCKING); `NP-HW-TACSDRV-001` (`OI-TACSDRV-01…03` plus `OI-TCAP-03`). **The two items to start with are the ones that block work already in flight:** `OI-NASAL-01`, because a baselined tool is dimensioned against an unspecified part, and `OI-TACSDRV-01`, because it decides which artifact row and which risk register own A16. | Systems + ME + EE | **G2 completeness; T1 tooling release; every artifact FAI except `NP-FAI-HUB-001`** |
