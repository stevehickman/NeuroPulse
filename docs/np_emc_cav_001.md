...
**Change Summary:** Rev 10 folds in **`BOARD-1`** — the board sits at the cluster's PAN-facing edge, making `PLATE-1`'s pocket nearly free, and selected by four independent constraints. `OI-EMCCAV-13` closed on structure. See §11.
