...
**Change Summary:** Rev 13 corrects Rev 12's remaining error: the module surface is **median-curved, not flat** (`R_m ≈ 87 mm`, 3.1 mm dome), and its curvature mismatch is **already budgeted** — 1.04 mm worst case, absorbed at L0. `OI-EMCCAV-15` withdrawn. See §11.
