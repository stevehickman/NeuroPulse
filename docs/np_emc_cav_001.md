...
**Change Summary:** Rev 5 adds §8.5 — `FLUSH-1` removes *travel* from the assembled-state Gap, re-opening a lever worth **0.0385 m²K/W per mm** on the largest outward term. Two mm beats deleting Layer 4 entirely. See §11.
...
| fluxgate sensors on the inner bowl (`NP-HEX-ZM-001` §5.3.1) | local, few |
