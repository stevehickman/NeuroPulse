...
| Host-native logic verified (Class C, 7 targets) | NP-SW-001 Rev C | `safety-mcu-ci.yml` — `host-tests` job. Seventh target `np_hal_platform_tests` added at phase 7 (§4.4.2) |
