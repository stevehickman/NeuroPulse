...
| NP-DHF-001 | Design History File Index (this document) | X | 2026-07-27 | [np_dhf_001.md](./np_dhf_001.md) | ACTIVE | QMS |
...
| NP-SW-001 | IEC 62304 Software Development Plan — Rev B (PR #217) accepted SR-FAN-01..06 fan-health thermal interlock into §6.2; Rev C adds §5.2.1 ZONE_ID debounce requirement (RISK-18), closing the corresponding pending-decisions.md item | C | 2026-07-27 | [np_sw_001.md](./np_sw_001.md) | ACTIVE | QMS |
...
| NP-DT-001 | Design Input/Output Traceability Matrix — 57 design inputs (DI-PERF/SAFE/USE/REG/INT), 35 design outputs, 13 verification evidence entries; full DI→DO→VE traceability matrix; DHF completeness design-inputs row upgraded from Partial to Good; 5 open items (OI-DT-01..05); G2 exit criterion per NP-DP-001 §6.4. **Rev B (2026-07-22, PR #217):** DI-SAFE-13 added (face ≤42°C under loss of forced convection; Path B1 + SR-FAN-03 + ambient/duty gate); DI total 57→58 | B | 2026-07-22 | [np_dt_001.md](./np_dt_001.md) | ACTIVE | QMS |
| NP-HFE-001 | Human Factors Engineering Plan — IEC 62366-1 / FDA HFE Guidance 2016; use specification; 7-critical-task URRA (CT-01..CT-07); formative plan (n=5–8 general + n=5 Parkinson's/post-stroke eject-lever study, requires NP-IRB-001); summative plan (n=15, Month 14–18); 6 open items (OI-HFE-01..06); closes NP-DT-001 OI-DT-03 | A | 2026-07-27 | [np_hfe_001.md](./np_hfe_001.md) | ACTIVE — plan authored; formative/summative testing execution remains open (NP-DT-001 VE-12) | QMS |
| NP-PMS-001 | Post-Market Surveillance Plan — ISO 13485:2016 §8.2, 21 CFR Part 803 (T2 post-510(k)); complaint intake/record (§820.198) — Rev B adds website contact form, priority-support phone line, and website chatbot to §3.1 intake channels; SHDR fleet trend cadence tied to CLAUDE.md §5.2 predictive-maintenance phases; MDR reporting decision tree; CAPA/NP-RM-001 §12 linkage; NP-SEC-BR-001 dual-track incident handoff; annual review; 4 open items (OI-PMS-01..04) | B | 2026-07-27 | [np_pms_001.md](./np_pms_001.md) | ACTIVE — plan authored; operational execution (Year 1–2) remains open | QMS |
| NP-IRB-001 | IRB Protocol for Research Consent Architecture Validation — Type A (device usability, e.g. eject-lever study) vs Type B (clinical/observational via NP-FW-ANON-001) study distinction; primary pathway Rashidi-Ranjbar/Unity Health REB + parallel 45 CFR §46.104(d)(4) exemption; fallback WCG/Advarra + CEO sponsor-investigator + OHRP FWA; 6 open items (OI-IRB-01..06) | A | 2026-07-27 | [np_irb_001.md](./np_irb_001.md) | DRAFT — template authored; PI outreach (OI-IRB-01) not yet initiated; approval pending | QMS |
...
| NP-FW-PBM1064-001 | 1064nm Smart Zone Module Firmware Specification — Rev B adds §6.6 factory calibration procedure, closing OI-PBM-04 | B | 2026-07-27 | [np_fw_pbm1064_001.md](./np_fw_pbm1064_001.md) | ACTIVE | SPEC-FW |
...
| Doc number | Title | Rev | Date | File | Status | Category |
|---|---|---|---|---|---|---|
| NP-RISK-001 | Zone Module Risk Register (RISK-01 through RISK-26) | C | 2026-07-22 | [neurone_fpc_zone_module_risks_revA.docx](./neurone_fpc_zone_module_risks_revA.docx) | ACTIVE | RISK |
...
These thirteen documents are the design-study output of the helmet layer-geometry work (2026-07-21; NP-THERM-CFD-R1-001 added 2026-07-22). They derive the four-station helmet layer stack (L0 per-module sealed faces → L1 socket layer → L2/L3 bonded EMF shell) from physical requirements, and follow the thermal-safety thread it opens through to a firmware module-boundary decision. **None is tooling-locked** — each is a design study whose numbers are provisional pending THERM-1a (the conjugate-heat CFD) and component datasheets. They are indexed here for traceability and will formalise into design inputs (NP-DT-001) and hardware/firmware specs as their gates close. Where a study surfaces a new hazard or requirement (NP-FMEA-GEOM-001 → FMEA-G07-01; NP-REQ-FANHEALTH-001 → SR-FAN-01…06), registering it into NP-RISK-001 / NP-SW-001 under change control is a tracked follow-on. At Rev U no existing controlled document was modified — cross-references into CLAUDE.md and prior specs were citations only. **Rev V (2026-07-22)** registers the THERM-1a first-pass outcome (NP-THERM-CFD-R1-001) into the cluster: NP-REQ-FANHEALTH-001 §4a (Path A rejected, Path B1 selected, provisional SR-FAN-03/04 constants), NP-FMEA-GEOM-001 (FMEA-G07-01 closure path), NP-HELMET-GEOM-001 §8 (THERM-1a gate status), and adopts the BN-boss conductive export as base thermal design (completed-decisions.md). The NP-RISK-001 `.docx` **RISK-26 line assigned (register Rev B→C)** for FMEA-G07-01, with the Path B1 mitigation/closure path and OPEN status.

| Doc number | Title | Rev | Date | File | Status | Category |
|---|---|---|---|---|---|---|
| NP-HELMET-GEOM-001 | Helmet Layer Geometry & Material Constraints — four-station stack; radial stack-up offset from scan datum; per-layer materials; key structural elements; MTBF/cost comparison | A | 2026-07-21 | [np_helmet_geom_001.md](./np_helmet_geom_001.md) | DESIGN STUDY — not tooling-locked | SPEC-HW |
| NP-HELMET-GEOM-ISA | Helmet Layer Geometry ISA (companion; ISC-1…11) | A | 2026-07-21 | [np_helmet_geom_isa.md](./np_helmet_geom_isa.md) | DESIGN STUDY | SPEC-HW |
| NP-THERM-BEZEL-001 | THERM-1/BEZEL-1 Coupling Analysis — bezel as thermal decoupler (scalp ≤42 °C vs 62 °C junction); bezel set 1.0 mm; electrode aperture bezel-free | A | 2026-07-21 | [np_therm_bezel_001.md](./np_therm_bezel_001.md) | DESIGN STUDY | SPEC-HW |
| NP-THERM-CFD-001 | THERM-1a Conjugate-Heat CFD Boundary Conditions | A | 2026-07-21 | [np_therm_cfd_001.md](./np_therm_cfd_001.md) | DESIGN STUDY — analysis pending run | SPEC-HW |
| NP-THERM-CFD-C2-001 | THERM-1a Case C2 Go/No-Go Run Card (Path-A admissibility; 1D pre-check predicts NO-GO) | A | 2026-07-21 | [np_therm_cfd_c2_001.md](./np_therm_cfd_c2_001.md) | DESIGN STUDY | SPEC-HW |
| NP-THERM-CFD-R1-001 | THERM-1a First-Pass Analysis Results (C2/C3/C6) + BN-Boss Conductive-Export Study — 1D + rough FD; **Path A rejected, Path B1 selected, provisional SR-FAN-03/04 constants**; BN-boss conductive export adopted as base thermal design | A | 2026-07-22 | [np_therm_cfd_r1_001.md](./np_therm_cfd_r1_001.md) | DESIGN STUDY — analysis provisional (verification-grade CFD + THERM-1b open) | SPEC-HW |
| NP-FMEA-GEOM-001 | Helmet Layer-Stack Hardware FMEA — mechanical failure modes in the NP-RM-001 S×P framework; surfaces FMEA-G07-01 (fan-loss scalp-overheat gap) | A | 2026-07-21 | [np_fmea_geom_001.md](./np_fmea_geom_001.md) | DESIGN STUDY — feeds NP-RISK-001 | RISK |
| NP-REQ-FANHEALTH-001 | Forced-Convection (Fan) Health Thermal Interlock Requirement (SR-FAN-01…06) — drafted against NP-SW-001 §6.2 | A | 2026-07-21 | [np_req_fanhealth_001.md](./np_req_fanhealth_001.md) | DRAFT — pending change-control acceptance | REQ |
| NP-PLAN-FANHEALTH-001 | Fan-Health Interlock Sequenced Work Plan (OI-FAN-01…04) | A | 2026-07-21 | [np_plan_fanhealth_001.md](./np_plan_fanhealth_001.md) | DESIGN STUDY | COORD |
| NP-ENV-001 | Environmental Envelopes — survival/warranty vs operating; survival widen to −20/+60 °C; hybrid protocol gating; humidity survival-only | A | 2026-07-21 | [np_env_001.md](./np_env_001.md) | DESIGN STUDY | REQ |
| NP-ENV-OPRANGE-001 | Per-Modality Operating-Range Working Spec (modality → module → protocol) | A | 2026-07-21 | [np_env_oprange_001.md](./np_env_oprange_001.md) | DESIGN STUDY — bounds provisional | REQ |
| NP-FW-POE-001 | Protocol Operating-Envelope Encoding — signed POE block; MCU-table-authoritative min() enforcement | A | 2026-07-21 | [np_fw_poe_001.md](./np_fw_poe_001.md) | DESIGN STUDY | SPEC-FW |
| NP-FW-M09-ARCH-001 | Architecture Decision — operating-envelope gate as new module SW01-M09 vs. extending SW01-M04 | A | 2026-07-21 | [np_fw_m09_arch_001.md](./np_fw_m09_arch_001.md) | DESIGN STUDY | SPEC-FW |
...
| ~~NP-HFE-001~~ | ~~Human Factors Engineering Plan~~ | ~~Month 9~~ | **COMPLETE — NP-HFE-001 Rev A released 2026-07-27; formative/summative testing execution remains open (NP-DT-001 VE-12)** |
...
| NP-IRB-001 | IRB Protocol — research anonymisation and consent architecture | Month 9 | **Template drafted — NP-IRB-001 Rev A (DRAFT) released 2026-07-27; PI outreach and IRB/REB approval still required before first study descriptor deployment; NP-PRIV-REM-001 STEP-20 §4.4** |
...
| ~~NP-PMS-001~~ | ~~Post-Market Surveillance Plan~~ | ~~Month 12~~ | **COMPLETE — NP-PMS-001 Rev A released 2026-07-27; operational execution (Year 1–2) remains open per the plan's own open items** |
