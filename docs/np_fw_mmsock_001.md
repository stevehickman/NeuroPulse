...
`NP_HUB_PROTO_VERSION` bump (3 → 4 when written; **5 → 6** now that `OI-HEXTILE-25` took v4 and absolute emissions took v5, 2026-09-25); the parser gains three rejections (either side empty, sides overlap,
