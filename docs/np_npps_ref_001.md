...
**References:** NP-NPPS-GRAM-001 Rev 2 (`npps/grammar/npps.peggy`); NP-HEX-ZM-001 (module redesign)  
**Related Issues:** —  
**Gate:** —  
**IEC 62304 Class:** —
...
Complete summary of NPPS Rev 2 (source of truth: `npps/grammar/npps.peggy`, NP-NPPS-GRAM-001 Rev 2).
