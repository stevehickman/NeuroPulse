...
> each (Q1 own board; Q2 PAN; Q3 hub-side magnetics or none). Its closure path is: the principal
> takes or rejects the recommendation, and Q2's condition is discharged by `OI-TACSDRV-04`.
