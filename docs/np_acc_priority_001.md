...
| **11** | **Accessory port covers** (3-pack) | Port ingress. Magnetic, tethered, 3 installed + 2 spare | Every configuration | Shipping — ownership of the anchor posts is settled (**`OI-ART-07`** closed 2026-09-23: `NP-TOOL-HUB-001` F-02), but **no tooling document yet anchors these covers**: HUB F-02 names USB-C and a DFU/service port and omits the hub accessory ports (**`OI-HTOOL-08`**), and specifies compression-fit covers where this SKU is magnetic |
