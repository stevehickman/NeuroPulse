...
- **1064nm snap-in smart zone module upgrade (accessory):** Path B smart module architecture — on-module I2C-controlled LED driver IC drives all three wavelengths (660nm, 808nm, 1064nm) independently from existing 20-pin FPC connector. Smart module detected via 3.3kΩ ZONE_ID resistor (pin 18, ADC < 1100 counts). Hub enables dedicated LPI2C3 bus per slot on detection. Base modules unchanged. See NP-FW-PBM1064-001 Rev A.
...
- [ ] **1064nm smart module hardware — FPC layout variant, mould variant, InGaAs PD selection, 1064nm LED emitter binning spec (Issue #54 BLOCKING for FAI-SM-04, FAI-SM-06)**
- [ ] **1064nm smart module — on-module I2C LED driver IC selection (3 channels, 120–180mA/ch, I2C 0x30) — hardware decision required before PCB layout (Issue #53)**
- [ ] **RISK-03 regulatory opinion scope expansion: must include 1064nm irradiance, three-channel aggregate irradiance (600 mW/cm² limit OI-PBM-05), and any T2 combined 1064+1170nm claim (Issue #55)**
...
- [ ] **1064nm FTC bibliography extension: add Yao et al. Science Advances 2022 + UT Dallas follow-ons to neuropulse_bibliography.docx (Issue #55)**
...
- **1064nm smart zone module — Path B architecture locked (NP-FW-PBM1064-001 Rev A, 2026-05-12):** On-module I2C-controlled LED driver IC (3 channels: 660nm CH_A, 808nm CH_B, 1064nm CH_C). Smart module ZONE_ID = 3.3kΩ resistor on pin 18 → ADC < 1100 counts (12-bit, 10kΩ pull-up, 3.3V ref). Hub enables LPI2C3 per slot independently (5 separate buses); I2C probe to address 0x30; ACK within 5ms required. Base modules (ZM-01..ZM-05, ADC 1100–4000 counts) continue via direct-PWM path — unchanged. Duty cycle ceiling 25% unconditionally enforced at hub firmware layer (DUTY_MAX_REG = 0x32). InGaAs PDs in PD1+PD2 positions; calibration coefficients (K_PD1, K_PD2, K_ratio_nom) per zone per wavelength in Config partition. Session dose limits: 660/808nm = 60 J/cm², 1064nm = 36 J/cm². Aggregate irradiance ceiling 600 mW/cm² (OI-PBM-05: pending RISK-03 scope expansion). Session descriptor schema v4. EEG-adaptive: uniform mode (default) and cortical gradient mode (Research, OI-SES-02). Firmware: firmware/pbm_1064nm/. Issues: #52 (firmware), #53 (hardware), #54 (T2 combined), #55 (regulatory/bibliography).
...
| 1064nm Smart Zone Module Firmware | `docs/neuropulse_fw_pbm1064_001.md` + `firmware/pbm_1064nm/` | NP-FW-PBM1064-001 Rev A (2026-05-12) — Issues #53, #54, #55. Smart module detection (3.3kΩ ZONE_ID, ADC < 1100 counts, 3×100ms debounce RISK-18). I2C bus: LPI2C3, 100 kHz, per-slot independent buses, driver IC address 0x30. Three-channel LED control (CH_A=660nm, CH_B=808nm, CH_C=1064nm): registers 0x00–0x0D (STATUS, CH_ENABLE, CUR, PWM_FREQ, DUTY, THERMAL, FAULT_LATCH, CONFIG). Duty cycle ceiling 0x32 (25%) enforced unconditionally in hub firmware. InGaAs PD dose-metering: K_PD1, K_PD2 coefficients (mW/cm²/count) per zone per wavelength from Config partition (factory cal) or firmware defaults. PD1/PD2 ratio: fouling vs aging disambiguation (RISK-14 Option B, 1064nm-specific coefficients). Aggregate irradiance ceiling 600 mW/cm² three-channel combined (pending regulatory opinion OI-PBM-05). Session dose limits: 60 J/cm² for 660/808nm, 36 J/cm² for 1064nm. T2 combined session: np_pbm1064_t2_combined coordinates 1064nm zone modules + 1170nm laser; thermal throttle priority 1170nm first → CH_C → CH_B. FAI-SM-01 through FAI-SM-11 (software PASS; FAI-SM-04/06/07 require calibrated optical bench, blocking for hardware FAI gate Issue #53). 8 HAL stubs OI-PBM-01 through OI-PBM-08. |
| 1064nm Multi-Wavelength Session Protocol | `docs/neuropulse_session_protocol_1064_001.md` | NP-SES-1064-001 Rev A (2026-05-12) — Issues #52, #54. Session descriptor v4 with smart_module_mask, per-zone np_pbm1064_preset_t, t2_combined_enable, Ed25519 signature extension. T1 three-wavelength session lifecycle (preflight, ramp, steady, ramp-down, UHDR/SHDR). EEG-adaptive frequency: uniform mode (default) and cortical gradient mode (experimental — Research mode label, OI-SES-02). T2 combined 1064+1170nm session: sLORETA coordination for depression protocol (§4.4, requires T2 prototype). Dose limits enforced per channel per zone. UHDR: irradiance time series, dose, NTC, throttle events, EEG-adaptive events, 1170nm dose, sLORETA MNI coordinate. SHDR: PD1/PD2 ratio final, fouling/aging flags, driver fault count, peak NTC (no timestamp), cal source. App display requirements: per-zone per-wavelength irradiance + dose bars, depth tier illustration, module management screen. Clinical evidence: Yao et al. Science Advances 2022 (UT Dallas/Harvard, right prefrontal 1064nm, working memory CDA). 5 open items OI-SES-01 through OI-SES-05. |
