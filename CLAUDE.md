...
| Engineering Coordination Checklist | `docs/neuropulse_eng_coordination_checklist.docx` | NP-COORD-001 Rev A.4 (2026-05-11) — G1 (15 items), G2 (12 items), G3 (6 items) gate structure; G1-16 CLOSED (NP-FW-EMMC-001 Rev A, eMMC partition + dual-bank OTA bootloader spec — Issue #19); G2-11 CLOSED; **G2-12 CLOSED** (NP-FW-HRV-001 Rev A, HRV biofeedback protocol firmware — Issue #21); G2-13 OPEN (lens assembly G2 deliverable) |
