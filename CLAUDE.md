...
- [ ] **Adaptive stimulation transparency: firmware adaptation log + app UI + privacy notice (STEP-33)** — np_adaptation_event_t struct in hub_control firmware; "Adaptive Adjustments" card in Session History screen; GDPR Art. 13(2)(f) disclosure in privacy notice; T2 clinical report in NP-API-001. Must precede session runner implementation and session-results UI design. See NP-PRIV-REM-001 STEP-33.
