...
- [ ] **Minimum age declaration in app consent flow** — add "I confirm I am 16 years of age or older" declaration before consent flow completes. Covers COPPA (under-13 bar), GDPR Art. 8 (under-16 bar in most EU states), and BIPA (minors cannot provide valid biometric written release). See NP-PRIV-001 Rev B MEDIUM-03.
