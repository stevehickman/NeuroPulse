...
| Engineering Coordination Checklist | `docs/neuropulse_eng_coordination_checklist.docx` | NP-COORD-001 Rev A.3 (2026-05-10) — G1 (14 items), G2 (12 items), G3 (6 items) gate structure; G2-11 CLOSED; G2-13 OPEN (lens assembly G2 deliverable, closes OI-9 from NP-TOOL-LENS-001 Rev B) |
