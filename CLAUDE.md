...
- [ ] **OI-PBM-HW-01 (BLOCKING): Hub PCB Rev B must add Vishay DG2788A per-slot analog switch (×5, $0.75–1.25 BOM) to reduce TIA Rf 47kΩ→22kΩ for InGaAs PD slots (2× higher responsivity saturates TIA at current gain). ZONE_ID detection triggers gain switch before I2C enable. Required before FAI-SM-04/06 optical bench tests.**
