...
- [ ] **QMS — author Design Input/Output Traceability Matrix (NP-DT-001)** — Month 6 target. Links all requirements to verification evidence.
...
- [ ] **T2 scripting API spec (NP-API-001)** — before T2 scripting API is designed. G1 gate target. See NP-PRIV-REM-001 STEP-15.
...
- [ ] **SW-01 Safety MCU unit-level FMEA** — per NP-SW-001 §11 (IEC 62304 §7.1 for Class C): identify all software failure modes for SW01-M01..M08 with potential harm and response time.
