...
| Design History File Index | `docs/neuropulse_dhf_index_001.md` | NP-DHF-001 Rev A (2026-05-13) — Issue #33. Master DHF index per 21 CFR §820.30(j). All pre-formation design documents (NP-DB-001 through current CLAUDE.md Rev 8, all NP-HW/FW/TOOL/FAI/PROC/COORD/REG/CLIN documents) retroactively entered under change control at QMS establishment. Firmware source code directories declared as DHF design output records. DHF completeness assessment (8 design phases, gap analysis). Planned near-term additions (NP-DP-001, NP-DT-001, NP-HFE-001, NP-PMS-001). Closes Issue #33 DHF initiation requirement. |
