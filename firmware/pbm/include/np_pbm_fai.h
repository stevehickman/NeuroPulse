...
np_pbm_fai_result_t np_pbm_fai_sm01(void); /* ADC detection, all 5 slots */
np_pbm_fai_result_t np_pbm_fai_sm02(void); /* I2C probe ACK, 50-cycle    */
np_pbm_fai_result_t np_pbm_fai_sm03(void); /* Base module compat          */
np_pbm_fai_result_t np_pbm_fai_sm04(void); /* HW bench — returns PENDING  */
np_pbm_fai_result_t np_pbm_fai_sm05(void); /* Duty cycle ceiling 25%      */
np_pbm_fai_result_t np_pbm_fai_sm06(void); /* HW bench — returns PENDING  */
np_pbm_fai_result_t np_pbm_fai_sm07(void); /* HW bench — returns PENDING  */
np_pbm_fai_result_t np_pbm_fai_sm08(void); /* HW bench — returns PENDING  */
np_pbm_fai_result_t np_pbm_fai_sm09(void); /* Thermal throttle cascade    */
np_pbm_fai_result_t np_pbm_fai_sm10(void); /* T2 combined state machine   */
np_pbm_fai_result_t np_pbm_fai_sm11(void); /* UHDR/SHDR data routing      */
