 ...
 * Document: NP-SW-CI-001 §4.12 (closes OI-SWCI-42), §4.8 (phase 8), §4.10 (phase 9)
 ...
 * follow, and §4.12 is the measurement that shows why: DTCM held .data —
 * 308 bytes — plus a .stack pinned at the far end of the region, and nothing
 * else.  Of the 131,072 B that exist at 0x20000000 under the DEFAULT eFuse
 * partition, before any register is written, 130,764 were unallocated.  The
 ...
 * and no register to be written.  ucHeap (65,536 B) and .data (308 B) occupy
 * 65,848 B of that window and leave 65,224 B.  So np_flexram_apply_partition()
 ...
 * — §4.10.6 pinned it to the top of the ESTABLISHED 512 KiB, and §4.12.3 keeps
