/*
 * NeuroPulse 1064nm Smart Zone Module — Detection API
 * Document: NP-FW-PBM1064-001 Rev A §4
 */

#ifndef NP_PBM1064_DETECT_H
#define NP_PBM1064_DETECT_H
 ...
 */
typedef struct {
    np_sm_slot_ctx_t slots[NP_PBM1064_ZONE_COUNT];
...
/*
 * Poll one tick for all 5 slots.  Call at NP_PBM1064_POLL_IDLE_MS intervals
