...
The /editscripts directory contains generated scripts that Claude used to modify documents. The content of that directory is probably not for human consumption.
